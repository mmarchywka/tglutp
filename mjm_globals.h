...
#ifndef MM_GLOB_ALLOC
#define MM_EXTERN_X 1 
...
#else
MM_EXTERN bool mm_err_enable; // =true; 
MM_EXTERN bool mm_delete_temps; // =true; 
 MM_EXTERN  int mm_err_io; // =0;
 MM_EXTERN std::vector<int> State;
MM_EXTERN void push();
MM_EXTERN void pop();
MM_EXTERN  void push_verbose(const bool x );
